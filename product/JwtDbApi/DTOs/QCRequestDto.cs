...
namespace JwtDbApi.DTOs
{
    public class QCRequestDto
    {
        ...
        public ProductDto? Product { get; set; } // Object to store product details like name, description, image, MRP, etc and also objects of BasicDetails and OptionalDetails
